          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Outmade Ltd (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Lifemade mobile application and web services (&quot;App&quot;).
              </p>
              <p className="text-gray-700 mb-4">
                Lifemade is a collaborative travel planning platform that helps you organize trips, share itineraries with friends and family, manage packing lists, store travel photos, and keep all your travel information in one organized place.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                To exercise these rights, please contact us at support@lifemade.app or use the data export and account deletion features within the app.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-700">
                ...
                <p className="mb-2">Email: <a href="mailto:support@lifemade.app" className="text-blue-600 hover:text-blue-800">support@lifemade.app</a></p>
